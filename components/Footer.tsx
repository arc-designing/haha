                    ...
                    <section className="pt-2 pb-5 text-true-gray-400" dark="text-true-gray-500">
                        <div className="flex justify-between w-full pb-2 my-2 text-xs border-b border-footer items-end" dark="border-true-gray-700">
                            <div className="flex flex-col gap-2">
                                ...
                                <p className="group">Design & Build with <span className="group-hover:text-red-400 transition-colors duration-500 ease-in-out">❤</span> by <a className="text-true-gray-600 hover:underline" href="https://mp.weixin.qq.com/s/KRHedQRO6BoXwOSWzWSJHQ" target="_blank" rel="noopener noreferrer" dark="text-true-gray-400">MannyCooper & TeleGalaxy</a></p>
                            </div>
                            <p className="flex flex-col items-end">
                                <a className="hover:underline" href="https://mp.weixin.qq.com/s/KRHedQRO6BoXwOSWzWSJHQ" target="_blank" rel="noopener noreferrer">Allen</a>
                            </p>
                        </div>
